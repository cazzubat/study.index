...
// 04 - Crie um algoritmo em que o usuário informe três números (n1, n2 e n3). Após, exiba na tela (terminal) a ordem decrescente desses números.


// 05 - Crie um algoritmo em que o usuário informe sua idade. Após, exiba na tela (terminal) se o usuário é ou não maior de idade.


// 06 - Crie um algoritmo em que o usuário informe seu gênero, sua altura e seu pese. Após, calcule e exiba na tela (terminal) o IMC do usuário.


// 07 - Crie um algoritmo em que o usuário informe um número qualquer. Após, informe se esse número é par ou ímpar.


// 08 - Crie um algoritmo em que o usuário informe um número qualquer. Após, informe se esse número é múltiplo de 2.


// 09 - Crie um algoritmo em que o usuário informe um número qualquer. Após, informe se esse número é múltiplo de 3.


// 10 - Crie um algoritmo em que o usuário informe um número qualquer. Após, informe se esse número é múltiplo de 5.
